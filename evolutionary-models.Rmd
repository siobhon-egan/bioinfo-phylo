...
Some common programs to carry out phylogenetic analysis include [MrBayes], [PAUP*](https://paup.phylosolutions.com/), [BEAST v2](http://www.beast2.org), [PhyML v3](http://www.atgc-montpellier.fr/phyml/) and [PAML](http://evomics.org/resources/software/molecular-evolution-software/paml/). [RAxML](https://sco.h-its.org/exelixis/software.html) generally only utilises the GTR model, although you can use JC and K80 models for DNA partitions. The below also include the settings if the model is available in these programs.

http://phylobotanist.blogspot.com/2016/06/implementation-of-substitution-models.html
...
![MEGA7_ModelSelection](MEGA7_ModelSelection.png)