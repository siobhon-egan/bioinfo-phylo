...
* [RAxML](https://sco.h-its.org/exelixis/software.html) generally only utilises the GTR model, although you can use JC and K80 models for DNA partitions. 

The below also include the settings if the model is available in these programs.
